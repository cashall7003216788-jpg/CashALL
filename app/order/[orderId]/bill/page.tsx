    ...
    const fetchBill = async () => {
      try {
          ...
          if (genRes.ok) {
            ...
            if (bd) {
              ...
              setBill({
                ...
                quotedPrice: bd.financials?.quotedPrice ?? bd.financials?.estimatedPrice ?? bd.financials?.finalPurchasePrice ?? 0,
                requotedPrice: bd.financials?.requotedPrice ?? bd.financials?.finalPurchasePrice ?? bd.financials?.estimatedPrice ?? 0,
        ...
        setBill({
          ...
          finalPrice: Number(payment?.amount ?? ord.finalPrice ?? ord.requotedPrice ?? ord.revisedPrice ?? ord.estimatedPrice ?? 0),
