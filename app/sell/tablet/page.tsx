...
import { Search, ChevronRight, Tablet } from "lucide-react";
...
export default function TabletBrandSelectionPage() {
  ...
  useEffect(() => {
    async function loadBrands() {
      try {
        const res = await fetch("/api/v1/catalog?category=TABLET");
        ...
        console.error("Error loading tablet brands", e);
      }
    }
    loadBrands();
  }, []);
      ...
      <main className="flex-grow py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 text-xs font-semibold text-brand-muted mb-6">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-brand-black font-bold">Sell Tablet</span>
          </div>
          ...
          <div className="text-center max-w-xl mx-auto mb-8">
            ...
            <p className="text-sm text-brand-muted mt-2">
              Select the manufacturer of the tablet or iPad you want to sell.
            </p>
          </div>
          ...
          <div className="max-w-md mx-auto mb-10 relative">
            ...
            <input
              ...
              placeholder="Search tablet brand (e.g. Apple iPad, Samsung, Lenovo, OnePlus)..."
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4">
                Supported Tablet &amp; iPad Manufacturers
              </h2>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {filteredBrands.map((brand) => (
                  ...
                  >
                    <BrandIcon name={brand.name} logoUrl={brand.logoUrl} fallbackType="TABLET" />
            ...
            {filteredBrands.length === 0 && (
              <div className="bg-white rounded-2xl p-12 text-center border border-brand-border">
                ...
                <p className="text-sm font-bold text-brand-black">No tablet brands matching &quot;{search}&quot;</p>
                <button
                  onClick={() => setSearch("")}
